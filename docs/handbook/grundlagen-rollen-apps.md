# Rollen, Apps & Anmeldung

Es gibt zwei Apps – je nach Rolle. Beide greifen auf dieselben Daten zu, zeigen aber
unterschiedliche Sichten.

## Die zwei Apps

| | Mitarbeiter-App | Teamlead-Cockpit |
|---|---|---|
...
Die Mitarbeiter-App startet immer mit der Anmeldung über die Mitarbeiternummer. Erst danach
...
> `'Admin & Regelpflege'`. Das ist Absicht.
