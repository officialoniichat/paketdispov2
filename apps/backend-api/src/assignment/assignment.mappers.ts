...
export function toGoodsReceiptCase(
  ...
  return {
    ...
    deliverySourceGroupKey: c.deliverySourceGroupKey ?? undefined,
    deliverySourceGroupSize: c.deliverySourceGroupSize ?? undefined,
    manualDeliveryGroupKey: c.manualDeliveryGroupKey ?? undefined,
    ...
    completedAt: c.completedAt ? ISO_DATETIME(c.completedAt) : undefined,
