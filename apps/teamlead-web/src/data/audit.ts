...
export const AUDIT_EVENT_LABELS: Record<WorkflowEventType, string> = {
  ...
  'bundle.extended': 'Bündel erweitert (weiteres Bündel angefordert)',
  'bundle.pack_advanced': 'Nächstes Pack angefordert',
  ...
  'position.confirmed': 'Position geprüft',
  'sku.quantity_confirmed': 'Menge erfasst',
  // Geteilter Beleg (Konzept beleg-zusammenarbeit §7): Zusammenarbeit als Overlay,
  // Teilbeleg erledigt ist ein Zustand des Beteiligten, nicht des Belegs.
  'case.collaboration_started': 'Gemeinsam zugewiesen',
  'case.collaboration_invited': 'Zur Zusammenarbeit eingeladen',
  'case.collaboration_accepted': 'Einladung angenommen',
  'case.collaboration_declined': 'Einladung abgelehnt',
  'case.collaboration_part_done': 'Teilbeleg erledigt',
  'case.collaboration_participant_removed': 'Aus geteiltem Beleg entfernt',
  'case.collaboration_dissolved': 'Zusammenarbeit beendet',
  ...
  'case.delivery_group_released': 'Beleg in den Pool gegeben',
  'case.delivery_group_held': 'Beleg zurückgehalten',
  'case.attention_flagged': 'Besondere Aufmerksamkeit markiert',
  'case.attention_cleared': 'Aufmerksamkeit entfernt',
  'case.forwarded': 'Weitergeleitet',
  'case.forward_cleared': 'Weiterleitung zurückgeholt',
};
